    ...
    n.n = e => {
        ...
        const Kn = function(t) {
                                ...
                                case 0:
                                    return e.abrupt("return", new Promise((function(e, t) {
                                        Ut("GetOfficers", {
                                            ...
                                            var n = t.officers;
                                            e(qn(n, o.assignedOfficers, "identifier"))
                                        }))
                                    })));
                                case 1:
                                case "end":
            ...
            return (0, e.useEffect)((function() {
                ...
                removable: !1
            }), v && qn(m, o.assignedOfficers, "identifier").map((function(t) {
                return e.createElement(gn, {
                    key: t.identifier,
                    id: t.identifier,
                    color: "white",
        ...
        const Xn = function(t) {
                                ...
                                case 0:
                                    return e.abrupt("return", new Promise((function(e, t) {
                                        Ut("GetPersons", {
                                            ...
                                            var n = t.persons;
                                            e(qn(n, o.assignedPersons, "identifier"))
                                        }))
                                    })));
                                case 1:
                                case "end":
            ...
            return (0, e.useEffect)((function() {
                ...
                description: "Fetching..",
                removable: !1
            }), v && qn(m, o.assignedPersons, "identifier").map((function(t) {
                return e.createElement(gn, {
                    key: t.identifier,
                    id: t.identifier,
                    color: "white",
        ...
        const cr = function(t) {
            ...
            var l, c, u = (l = (0, e.useState)(""), c = 2, function(e) {
                ...
                d = function(e, t) {
                    var n = !1;
                    return t.forEach((function(t) {
                        if (t.identifier === e.identifier) return n = !0, !0
                    })), n
                },
                p = function() {
            ...
            return (0, e.useEffect)((function() {
                ...
                icon: q
            })), v && m && m.identifier && e.createElement("div", {
        ...
        const Pr = function(t) {
                ...
                return Mn(r, n), e.createElement(an, {
                    ...
                    return e.createElement(gn, {
                        ...
                        pars: {
                            identifier: i.criminal.identifier
                        }
                    })
                }))), e.createElement(Cr, {
                    hoverEffect: !0,
        ...
        const Ir = function(t) {
                ...
                return e.createElement(e.Fragment, null, d && e.createElement("div", {
                    ...
                    name: "".concat(n.name, " (").concat(n.identifier, ")")
                    ...
                    readonly: i.readonly,
                    onClick: function(e) {
                        i.changeWarrant(n.identifier, e)
                    }
            ...
            Nr = function(t) {
                return e.createElement("div", {
                    ...
                    return e.createElement(Ir, {
                        key: n.identifier ? n.identifier : r,
                        id: n.identifier,
        ...
        const Dr = function(t) {
            ...
            return e.createElement("div", {
                ...
                return e.createElement(gn, {
                    ...
                    id: n.plate,
                    key: n.plate,
                    description: "".concat(n.plate, " ").concat(n.seize ? "(Seized)" : "", " / Fine: $ ").concat(n.fine),
                    removable: !t.readonly,
        ...
        const Yr = function(t) {
                ...
                return e.createElement(e.Fragment, null, e.createElement(jt, null, e.createElement(Lt, null, e.createElement(zt, {
                    ...
                    title: Language.success,
                    subTitle: "Incident saved with ID: ".concat(n),
                    onClick: function() {
                        I.reset()
                    }
        ...
        const hi = function(t) {
            var n = di((0, e.useState)(!1), 2),
                ...
                v = (0, r.useQuery)(["Profile", t.loadedProfile], fi
                ...
                S = function(e) {
                    E.mutate({
                        identifier: t.loadedProfile.trim(),
                        id: e
                    })
                };
            return (0, e.useEffect)((function() {
                ...
                name: "Licenses",
                adds: !1
            }, e.createElement(bn, null, licensesData[0] && y.info.metadata.licences[licensesData[0].id] && e.createElement(gn, {
                    id: licensesData[0].id,
                    color: licensesData[0].color,
                    description: licensesData[0].description,
                    removable: !0,
                    onRemove: S
                }), licensesData[1] &&y.info.metadata.licences[licensesData[1].id] && e.createElement(gn, {
                    id: licensesData[1].id,
                    color: licensesData[1].color,
                    description: licensesData[1].description,
                    removable: !0,
                    onRemove: S
                }),licensesData[2] && y.info.metadata.licences[licensesData[2].id] && e.createElement(gn, {
                    id: licensesData[2].id,
                    color: licensesData[2].color,
                    description: licensesData[2].description,
                    removable: !0,
                    onRemove: S
                }),licensesData[3] && y.info.metadata.licences[licensesData[3].id] && e.createElement(gn, {
                    id: licensesData[3].id,
                    color: licensesData[3].color,
                    description: licensesData[3].description,
                    removable: !0,
                    onRemove: S
                }),licensesData[4] && y.info.metadata.licences[licensesData[4].id] && e.createElement(gn, {
